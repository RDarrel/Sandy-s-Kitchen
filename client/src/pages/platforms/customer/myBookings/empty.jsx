...
const EmptyBooking = () => {
  return (
    <div className="flex items-center border bg-card border-dashed rounded-md justify-center h-full ">
      <Empty>
        <EmptyHeader>
          <EmptyMedia>
          ...
          <EmptyDescription className="whitespace-nowrap  text-muted-foreground">
