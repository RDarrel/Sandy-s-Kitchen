  ...
  const updateLineAddOns = ({ lineId, addOns = [] }) => {
    ...
    setCart((prev) => {
      ...
      const mergeIndex = prevLines.findIndex(
        (line, idx) =>
          idx !== index && String(line?.signature || "") === signature,
      );
      ...
      if (mergeIndex > -1) {
        ...
        nextLines[mergeIndex] = {
          ...base,
          quantity:
            (Number(base?.quantity) || 0) + (Number(target?.quantity) || 0),
        };
  ...
  return (
      ...
      <CustomizeAddOnsDialog
        ...
        onConfirm={() => {
          ...
          const recommended = Array.isArray(menu?.recommendedAddOns)
